...
// Trouve la position de la bobine dans la matrice et renvoie la ligne et colonne de la bobine
...
// Methode pour ajouter à la fin du vecteur les bobines à activer 
void addToVector(const std::vector<std::vector<int>>& matrix,std::vector<int>& chemin, const int row, const int col ){
